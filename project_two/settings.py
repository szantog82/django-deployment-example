...
from django.conf.global_settings import STATICFILES_DIRS, PASSWORD_HASHERS, \
    MEDIA_ROOT, MEDIA_URL, LOGIN_URL
import os
...
SECRET_KEY = '071_v6umuf0eb+fmvd$ho(^%v3y95r^6b#d=&mviw5l54-*q@*'
